...
const features = [
  {
    icon: "⚡",
    title: "Sin lag, en tiempo real",
    desc: "Streaming de menos de 500ms. Cada puja, cada carta, al instante.",
  },
  {
    icon: "🔍",
    title: "IA detecta tus cartas",
    desc: "Solo apunta la cámara. La IA identifica la carta y su valor sola.",
  },
  {
    icon: "🔒",
    title: "Tu dinero está protegido",
    desc: "Pagos con Mercado Pago. El dinero se libera solo cuando confirmas tu carta.",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-6 grid md:grid-cols-2 gap-12 items-center py-24">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4 mb-10">
            <Link
              href="/auctions"
              className="inline-flex items-center gap-2.5 font-bold px-7 py-4 rounded-2xl text-white transition-all active:scale-95"
              style={{
                background: "linear-gradient(135deg, #6C3AE8, #8B5CF6)",
                boxShadow: "0 8px 30px rgba(108,58,232,0.4)",
              }}
            >
            ...
            <Link
              href="#"
              className="inline-flex items-center gap-2 font-semibold px-7 py-4 rounded-2xl text-white border border-white/15 hover:border-white/30 hover:bg-white/5 transition-all"
            >
              Registrarse gratis →
            </Link>
          </div>
          ...
          <div className="flex items-center gap-3 text-sm text-zinc-500">
            <div className="flex -space-x-2">
              {["🧑", "👩", "🧑‍💻", "👨‍🦱", "👩‍🦰"].map((e, i) => (
                <div
                  key={i}
                  className="w-8 h-8 rounded-full bg-[#1E1E2A] border-2 border-[#0F0F14] flex items-center justify-center text-sm"
                >
                  {e}
                </div>
              ))}
            ...
            <span>
              <span className="text-white font-semibold">+2,400</span> cartas vendidas este mes
            </span>
          </div>
        </div>
        ...
        <div className="flex justify-center md:justify-end">
          <div className="float relative w-72">
            {/* EN VIVO */}
            <div
              className="absolute -top-3 -right-3 z-10 flex items-center gap-1.5 text-white text-xs font-bold px-3 py-1.5 rounded-full"
            ...
            <div
              ...
              style={{ border: "1px solid rgba(255,255,255,0.1)", boxShadow: "0 30px 80px rgba(0,0,0,0.6)" }}
            >
              {/* Stream area */}
              <div className="relative h-52 bg-[#0d0d1a] flex items-center justify-center">
                <div
                  className="w-28 h-36 rounded-xl flex flex-col items-center justify-center gap-1 shadow-2xl"
                  style={{
                ...
                <div className="absolute bottom-3 left-3 flex items-center gap-1.5 bg-black/60 backdrop-blur-sm rounded-full px-2.5 py-1 text-xs text-zinc-300">
                  👁 47 viendo
                </div>
                <div className="absolute bottom-3 right-3 bg-black/60 backdrop-blur-sm rounded-full px-2.5 py-1 text-xs font-mono font-bold text-white">
                  2:34
                </div>
              </div>
              ...
              <div className="p-4 bg-[#16161E]">
                ...
                <div className="flex items-end justify-between mb-4">
                  ...
                  <p className="text-sm text-zinc-400">
                    PokéVault_MX <span className="text-[#a78bfa]">✓</span>
                  </p>
                </div>

                <div className="grid grid-cols-2 gap-2">
                  <button
                    className="font-bold py-2.5 rounded-xl text-sm text-white transition-all"
                    style={{ background: "linear-gradient(135deg, #6C3AE8, #8B5CF6)" }}
                  >
                    Pujar →
                  </button>
                  <button className="font-semibold py-2.5 rounded-xl text-sm text-white border border-white/15 hover:bg-white/5 transition-all">
                    Comprar ya
                  </button>
                </div>
              </div>
            ...
            <div
              className="absolute -bottom-5 -left-6 bg-[#1E1E2A] rounded-xl px-3 py-2 flex items-center gap-2.5"
    ...
    <section id="live" className="py-20 border-t border-white/5">
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex items-center justify-between mb-10">
          ...
          <Link href="/auctions" className="text-sm text-[#a78bfa] hover:text-white transition-colors font-medium">
            Ver todas →
          </Link>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {liveAuctions.map((a) => (
            <div
              key={a.name}
              className="rounded-2xl overflow-hidden hover:scale-[1.02] transition-transform cursor-pointer"
            ...
            >
              ...
              >
                <div
                  className={`w-20 h-28 rounded-xl bg-gradient-to-br ${a.gradient} flex items-center justify-center text-3xl shadow-xl`}
                  style={{ boxShadow: `0 0 30px ${a.glow}` }}
                >
                  {a.emoji}
                </div>
                <div
                  className="absolute top-3 left-3 flex items-center gap-1.5 text-white text-[10px] font-bold px-2.5 py-1 rounded-full"
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="text-center mb-14">
          <h2 className="text-4xl md:text-5xl font-black mb-4">
            ...
            <span className="gradient-text">sin lo que no.</span>
          </h2>
          <p className="text-zinc-500 text-lg max-w-sm mx-auto">
            Sin complicaciones, sin apps raras, sin sorpresas.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {features.map((f) => (
            <div
              key={f.title}
              className="rounded-2xl p-7 hover:border-[#6C3AE8]/40 transition-all group"
              style={{ background: "#16161E", border: "1px solid rgba(255,255,255,0.06)" }}
            >
              <div
                className="w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mb-5"
                style={{ background: "rgba(108,58,232,0.15)", border: "1px solid rgba(108,58,232,0.2)" }}
              >
                {f.icon}
              </div>
              <h3 className="text-lg font-bold mb-2 group-hover:text-[#a78bfa] transition-colors">
                {f.title}
              </h3>
    ...
    <section className="py-20">
      <div className="mx-auto max-w-3xl px-6 text-center">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(108,58,232,0.25) 0%, rgba(139,92,246,0.08) 100%)",
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link
                href="#"
                className="font-bold px-8 py-4 rounded-2xl text-white transition-all active:scale-95"
                style={{
                  background: "linear-gradient(135deg, #6C3AE8, #8B5CF6)",
                  boxShadow: "0 8px 30px rgba(108,58,232,0.4)",
                }}
              ...
              <Link
                href="#live"
                className="font-semibold px-8 py-4 rounded-2xl text-white border border-white/15 hover:border-white/30 hover:bg-white/5 transition-all"
              >
                Ver subastas →
              </Link>
            </div>
    ...
    <footer className="border-t border-white/5 py-10">
      <div className="mx-auto max-w-7xl px-6 flex flex-col md:flex-row items-center justify-between gap-5">
        <div className="flex items-center gap-2.5">
          <div
            className="w-7 h-7 rounded-md bg-[#6C3AE8] flex items-center justify-center font-black text-xs"
            style={{ boxShadow: "0 0 12px rgba(108,58,232,0.4)" }}
          >
            T
          </div>
        ...
        <div className="flex gap-6 text-sm text-zinc-600">
          {["Subastas", "Shop", "Términos", "Privacidad", "Soporte"].map((l) => (
            <Link key={l} href="#" className="hover:text-zinc-300 transition-colors">
              {l}
            </Link>
          ))}
        </div>
